...
public class TransformImageView extends ImageView {
	...
	// 初始图片显示策略
	public static interface InitialImageShowStrategy{
		public Matrix getInitialMatrix(TransformImageView view, int drawableWidth,
    ...
    protected boolean updateTransformBaseIfNeed() {
        ...
        if (drawable == null) {
        	...
        	if (mInitialImageShowStratege != null){
                mBaseMatrix = mInitialImageShowStratege.getInitialMatrix(this,drawable.getIntrinsicWidth(),
